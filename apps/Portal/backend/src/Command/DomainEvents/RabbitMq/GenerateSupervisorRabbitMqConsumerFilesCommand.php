...
final class GenerateSupervisorRabbitMqConsumerFilesCommand extends Command
{
    ...
    {
        return <<<EOF
[program:Myfinance_{queue_name}]
command      = {path}/apps/portal/backend/bin/console Myfinance:domain-events:rabbitmq:consume --env=prod {queue_name} {events_to_process}
