...
namespace Myfinance\Shared\Infrastructure\Doctrine;

use Myfinance\Shared\Infrastructure\Doctrine\Dbal\DbalCustomTypesRegistrar;
...
final class DoctrineEntityManagerFactory
{
    private static $sharedPrefixes = [
        __DIR__ . '/../../../Shared/Infrastructure/Persistence/Mappings' => 'Myfinance\Shared\Domain',
    ];
